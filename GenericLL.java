...
public class GenericLL<NodeType> implements Serializable {
    ...
    public void delete(int index) {
        ...
        if (this.head != null) {
            ...
            if (targetNode == null) {
                ...
                // set the next and previous to the respective nodes, making the deleted node
                // vanish into a poof of memory
    ...
    public NodeType get(int i) {
        ...
        // since it is possible for any result to be null and return an error, we will
        // do some error handling to return a null
        try {
            if (i >= 0) {
    ...
    // getNode is for when we want the actual node and don't really care (as much)
    // about the data
